...
<!-- Bootstrap 4.1 css and custom css -->
        ...
        <div class="card headcard">
            <div class="card-body">
                <div style="display:flex;flex-wrap:wrap;">
                    <img style="height:60px;width:60px;margin-right:0.5em;" src="{{URL::asset('photomain/logo_tbh.png')}}">
                    <div>
                        <h2 class="card-title kanit">   ไทยแลนด์บล็อกฮับ</h2>
                        <h5 class="card-subtitle kanit">บล็อกไดเรกทอรี่ของบล็อกเกอร์ชาวไทย | Thailand Blog Directory</h5>
                    </div>
                </div>
            </div>  
        </div>
